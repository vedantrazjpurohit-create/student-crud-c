...
I wrote this while revisiting pointer basics before diving into heavier systems code. Nothing fancy, but it's clean, compiles with `gcc`, and handles the edge cases that usually break classroom submissions (newline after `scanf`, empty list deletes).
